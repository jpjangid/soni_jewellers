...
export class ApiServiceService {
  ...
  postSupplier(supplierId: any): Promise<any> {
    return this.http.put(this._baseurl + 'supplier', supplierId).toPromise();
  }
  ...
  getApqpData(): Promise<any> {
    return this.http.get(this._baseurl + 'APQP').toPromise();
  }
